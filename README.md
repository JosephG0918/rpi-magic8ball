...
```
chmod +x rpi-magic8ball/src/start_m8ball.sh
chmod +x rpi-magic8ball/src/shutdown_button.sh
chmod +x rpi-magic8ball/src/python_dir/m8ball_proj/setup_venv.sh
```

## Dependency Setup
> ⚠️ This script requires a Python virtual environment. Create the virtual environment and install dependencies by running:
```
cd rpi-magic8ball/src/python_dir/m8ball_proj
setup_venv.sh
```
